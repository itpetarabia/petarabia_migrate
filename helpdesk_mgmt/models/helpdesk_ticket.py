...
class HelpdeskTicket(models.Model):
    ...
    def _get_default_description(self):
        text = """
<strong>Issue Statement: What is the issue you have?</strong> <em>Here is a doc explaining how to <a href="https://docs.google.com/document/d/1c1Iw7e14xl3ggGf2gE0bvizznaWNa3IPtBcaZEfqVEo/edit?usp=sharing">write a good issue</a></em>


<strong>What are the steps to reproduce the issue?</strong> How would I find this issue? (You can do a video explaining this)


<strong>What are all the steps you used, to solve the issue?</strong>


<strong>How does this issue affect your work?</strong>

        """
        list_of_lines = text.split("\n")
        return "<br>".join(list_of_lines)
