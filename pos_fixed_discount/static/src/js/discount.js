odoo.define('pos_fixed_discount.posFixedDiscountButton', function(require) {
    'use strict';
    ...
    class posFixedDiscountButton extends PosComponent {
        constructor() {
            super(...arguments);
    ...
    posFixedDiscountButton.template = 'posFixedDiscountButton';

    ProductScreen.addControlButton({
        component: posFixedDiscountButton,
        condition: function() {
            return this.env.pos.config.module_pos_discount && this.env.pos.config.discount_product_id;
        },
    });

    Registries.Component.add(posFixedDiscountButton);

    return posFixedDiscountButton;
});
